            ...
            <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-4 w-full mt-10'>
              <div>
                <label className="input w-full">
                  ...
                  <input {...register("email")} placeholder="masukkan email anda" />
                </label>
              ...
              <div>
                <label className="input w-full">
                  ...
                  <input {...register("first_name")} placeholder="nama depan" />
                </label>
              ...
              <div>
                <label className="input w-full">
                  <svg className="h-[1em] opacity-50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g strokeLinejoin="round" strokeLinecap="round" strokeWidth="2.5" fill="none" stroke="currentColor"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></g></svg>
                  <input {...register("last_name")} placeholder="nama belakang" />
                </label>
              ...
              <div>
                <label className="input w-full">
                  ...
                  <input type="password" {...register("password")} placeholder='masukkan password anda' />
                </label>
              ...
              <div>
                <label className="input w-full">
                  ...
                  <input type="password" {...register("password_confirmation")} placeholder='konfirmasi password' />
                </label>
