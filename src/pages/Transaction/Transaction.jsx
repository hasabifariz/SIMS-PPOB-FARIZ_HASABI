...
const Transaction = () => {
  ...
  return (
    <div className='min-h-screen pt-20 md:pt-30'>
      ...
      <div className='mt-20 mb-10 gap-10 px-10 md:px-20 lg:px-50'>
        <p className='font-bold text-xl'>Semua Transaksi</p>
        {
          dataHistory?.map((item, index) => (
            <div key={index} className='border border-slate-200 rounded-xl p-5 mt-4 space-y-1 '>
          ...
          (
            hasNextPage ? (
              <div className="flex justify-center items-center w-full m-4 mb-10">
                <p
                  className="font-semibold text-red-500 text-lg cursor-pointer"
              ...
              :
              <div className="divider my-10 text-slate-500 text-sm">tidak ada transaksi lagi</div>
          )
        }
